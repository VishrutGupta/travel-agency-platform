...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState("owner@alpine-expeditions.com");
  const [password, setPassword] = useState("mountain123");
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col justify-between items-center p-6 selection:bg-[#4B6B5B]/20">
      {/* Top logo */}
